...
class Api
{
    ...
    public function CreateOrder($amount, $txnID, $callbackUrl, $customer, $paymentData, $billingAddress = [], $shippingAddress = [], $notes = [])
    {
        ...
        if ( isset($paymentData['pg']) && !empty($paymentData['pg']) ) {
            $body['pg'] = $paymentData['pg'];
        }

        if ( isset($paymentData['currency']) && !empty($paymentData['currency']) ) {
        ...
        if ( isset($paymentData['discount']) && !empty($paymentData['discount']) ) {
            $body['amount'] = (int)$body['amount'] - (int)$paymentData['discount'];
        }
